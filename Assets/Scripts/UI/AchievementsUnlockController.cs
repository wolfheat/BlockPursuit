...
public class AchievementsUnlockController : MonoBehaviour
{
    ...
    public void CheckForUnlock()
    {
        ...
        Debug.Log("Checking to unlock Achievement, amount of requirements: "+requirements.Length);
    ...
    {
        UnlockRequirementType type = requirements[i].type;

        //Debug.Log("Checking to unlock achievement index: "+i);

        int value = requirements[i].value;
